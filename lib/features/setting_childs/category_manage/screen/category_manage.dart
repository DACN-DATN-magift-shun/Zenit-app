...
return RefreshIndicator(
                  ...
                  onLongPress: () async {
                    ...
                    final selected = await showMenu<String>(
                      ...
                      position: RelativeRect.fromRect(
                        Rect.fromCenter(center: tapPosition, width: 1, height: 1),
                    ...
                    if (selected == 'delete') {
                      ...
                      if (confirm == true) {
                        ...
                        if (success) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text(categoryProvider.errorMessage ?? 'Xóa thất bại')),
                          );
                        }
                      }
                    }
  ...
  Color _getGroupChipColor(int groupType) {
    switch (groupType) {
      case 0:
        return Theme.of(context).extension<AppColorExtension>()!.successIcon; // Chi tiêu thiết yếu
      case 1:
        return Theme.of(context).extension<AppColorExtension>()!.primarySubtext; // Chi tiêu cá nhân
      case 2:
        return Theme.of(context).extension<AppColorExtension>()!.infoIcon; // Thu nhập
      case 3:
        return Theme.of(context).extension<AppColorExtension>()!.infoIcon;// Tiết kiệm
      case 4:
        return Theme.of(context).extension<AppColorExtension>()!.secondaryHover; // Đầu tư
      case 5:
        return Theme.of(context).extension<AppColorExtension>()!.primarySubtext; // Khác
      default:
  ...
  void _showAddCategoryDrawer(BuildContext context, int groupType, String groupName) {
    AppDrawer.showAsBottomSheet(
      ...
      showDragHandle: true,
      body: const Center(
        child: Text('Add category form will be here'),
      ),
    );
  }
}